 ...
 * Plot a histogram of the RTs by condition. Make on version where you plots the histograms in different facets, and another version where you have only one facet and use fill color to distinguish between conditions.
 ...
 * Try to make a pie chart that shows the proportion correct for the three conditions.
