...
This document provides an introduction to data wrangling and visualization in R. Following this class, you will be asked to apply the knowledge gain from this tutorial to *your own data*. **By this Wednesday, post at least one plot about your data on slack using the skills learned in this tutorial.** You are encouraged to ask questions (and help others) on slack. 

The document also contains sections marked as exercises. **Please complete these exercises by Friday** and submit them on slack. As with everything else, you're encouraged to ask questions about these problem sets and provide help on slack.
