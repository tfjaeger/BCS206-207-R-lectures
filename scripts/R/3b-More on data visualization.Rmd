...
# Overview
This tutorial introduces you to additional aspects of plotting in R, such as the use of themes to fine-tune your plots.
...
# Storing plots at specific sizes and aspect ratios

```{r}
ggsave(plot = p, filename = "../../figures/example_plot.png", 
       width = 16, height = 8, units = "cm", dpi = "print")
```
