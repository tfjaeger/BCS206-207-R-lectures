...
We will illustrate the use of *dplyr* with the following data from an experiment with a 2AFC task in three within-subject letter sizes (1, 2, 4), for which we have extracted correctness (1 = correct; 0 = incorrect) and reaction times (RT):
